...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log(`Attempting to fetch server info from: ${BACKEND_URL}/pterodactyl/server-info/${userId}`);
    
    const response = await fetch(`${BACKEND_URL}/pterodactyl/server-info/${userId}`, {
      method: 'GET',
      headers: {
